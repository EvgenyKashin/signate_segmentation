...
def main():
    ...
    parser.add_argument('--root', default='runs/debug', type=str)
    parser.add_argument('--train_crop_width', default=512, type=int)
    parser.add_argument('--train_crop_height', default=512, type=int)
    parser.add_argument('--val_crop_width', default=512, type=int)
    parser.add_argument('--val_crop_height', default=512, type=int)
